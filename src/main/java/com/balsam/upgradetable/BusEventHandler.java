...
import com.balsam.upgradetable.capability.ItemLevelProvider;
...
public class BusEventHandler {
    ...
    public static void onAttachCapabilitiesEvent(AttachCapabilitiesEvent<ItemStack> event) {
        ...
        if (object.getItem() instanceof SwordItem) {
            event.addCapability(new ResourceLocation(String.format("cap.%s.upgrade", Constants.MOD_ID)), new ItemLevelProvider());
